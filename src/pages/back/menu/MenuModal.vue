<template>
    <div class="MenuModalContainer">
        <a-modal
            ...
            width="400px"
        >
            <a-form :model="addMenuParams" :label-col="labelCol" :wrapper-col="wrapperCol">
                <a-form-item label="菜单名" v-bind="addForm.validateInfos.menuName" required>
                    <a-input v-model:value="addMenuParams.menuName" props="menuName" />
                </a-form-item>
                <a-form-item label="菜单类型" v-bind="addForm.validateInfos.menuType" required>
                    <a-radio-group name="menuTypeRadioGroup" v-model:value="addMenuParams.menuType">
                ...
                <a-form-item label="状态" v-bind="addForm.validateInfos.status" required>
                    <a-radio-group name="statusRadioGroup" v-model:value="addMenuParams.status">
                        <a-radio :value="1">正常</a-radio>
                        <a-radio :value="0">禁用</a-radio>
                    </a-radio-group>
                </a-form-item>
                <a-form-item label="是否删除" v-bind="addForm.validateInfos.isDelete" required>
                    <a-radio-group name="isDeleteRadioGroup" v-model:value="addMenuParams.isDelete">
                        <a-radio :value="1">是</a-radio>
                        <a-radio :value="0">否</a-radio>
                    </a-radio-group>
                </a-form-item>
                <a-form-item label="备注" v-bind="addForm.validateInfos.remark">
                    <a-input v-model:value="addMenuParams.remark" props="remark" />
                </a-form-item>
