<template>
    <div class="userModalContainer">
        <a-modal
            ...
            width="400px"
        >
            <a-form :model="addUserParams" :label-col="labelCol" :wrapper-col="wrapperCol">
                <a-form-item
                    label="用户账号"
                ...
                <a-form-item
                    ...
                    has-feedback
                >
                    <a-input v-model:value="addUserParams.username" props="username" />
                </a-form-item>
                <a-form-item
                    v-if="fields.id === 0"
                    label="密码"
                    ...
                    has-feedback
                >
                    <a-input v-model:value="addUserParams.password" props="password" />
                </a-form-item>
                <a-form-item label="手机号" v-bind="addForm.validateInfos.mobile">
                    <a-input v-model:value="addUserParams.mobile" props="mobile" />
                </a-form-item>
                <a-form-item label="邮箱" v-bind="addForm.validateInfos.email">
                    <a-input v-model:value="addUserParams.email" props="email" />
                </a-form-item>
                <a-form-item label="是否管理员" v-bind="addForm.validateInfos.ifManager" required>
                    <a-radio-group
                ...
                <a-form-item label="状态" v-bind="addForm.validateInfos.status" required>
                    <a-radio-group name="statusRadioGroup" v-model:value="addUserParams.status">
                        <a-radio :value="1">正常</a-radio>
                        <a-radio :value="0">禁用</a-radio>
                    </a-radio-group>
                </a-form-item>
                <a-form-item label="备注" v-bind="addForm.validateInfos.remark">
                    <a-input v-model:value="addUserParams.remark" props="remark" />
                </a-form-item>
                <a-form-item label="是否删除" v-bind="addForm.validateInfos.isDelete" required>
                    <a-radio-group name="isDeleteRadioGroup" v-model:value="addUserParams.isDelete">
                        <a-radio :value="1">是</a-radio>
                        <a-radio :value="0">否</a-radio>
                    </a-radio-group>
                </a-form-item>
