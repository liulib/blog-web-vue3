<template>
    <div class="roleModalContainer">
        <a-modal
            ...
            width="400px"
        >
            <a-form :model="addRoleParams" :label-col="labelCol" :wrapper-col="wrapperCol">
                <a-form-item label="角色名" v-bind="addForm.validateInfos.roleName" required>
                    <a-input v-model:value="addRoleParams.roleName" props="roleName" />
                </a-form-item>
                <a-form-item label="备注" v-bind="addForm.validateInfos.remark">
                    <a-input v-model:value="addRoleParams.remark" props="remark" />
                </a-form-item>
                <a-form-item label="是否删除" v-bind="addForm.validateInfos.isDelete" required>
                    <a-radio-group name="isDeleteRadioGroup" v-model:value="addRoleParams.isDelete">
