<template>
    <div class="roleContainer">
        <a-button type="primary" class="addButton" @click="showAddRoleModal(0, null)">新增角色</a-button>
        <a-table
            :columns="columns"
        ...
        >
            ...
            <template #operation="{ record }">
                ...
                >编辑</a-button>
                <a-button danger @click="showDeployMenuModal(record)">赋权</a-button>
            </template>
        </a-table>
        <RoleModal
            v-if="addRoleVisible"
        ...
        ></RoleModal>
        <DeployMenu
            v-if="deployMenuVisible && checkedRole"
    ...
    setup() {
        ...
        const getRoleListReq = async () => {
            try {
                ...
                // 赋值分页
                data.reqParams.page = data.pagination.current;
        ...
        const showAddRoleModal = (type: number, editData: role | null) => {
            // 处理数据
            if (type) {
